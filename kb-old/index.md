...
## Class-Type Pages
- [Class Structure Principles](class-types/class-structure-principles.md) (`confidence: 0.90`, `status: active`)
- [Competition Training Session Framework](class-types/competition-training-session-framework.md) (`confidence: 0.85`, `status: active`)
- [Kids Age and Duration Guidelines](class-types/kids-age-and-duration-guidelines.md) (`confidence: 0.90`, `status: active`)
- [Youth 60-Minute Class Template](class-types/youth-class-template-60-minutes.md) (`confidence: 0.90`, `status: active`)
...
- [Kids Sparring Guidelines](policies/sparring-guidelines.md) (`confidence: 0.90`, `status: active`)
- [Mat Safety Program](policies/mat-safety-program.md) (`confidence: 0.90`, `status: active`)

## Position Pages
- [Guard Framework](position/guard-framework.md) (`confidence: 0.85`, `status: active`)
- [Knee on Belly System](position/knee-on-belly-system.md) (`confidence: 0.80`, `status: active`)
- [Mount System](position/mount-system.md) (`confidence: 0.80`, `status: active`)
- [North-South System](position/north-south-system.md) (`confidence: 0.80`, `status: active`)
- [Passing Framework](position/passing-framework.md) (`confidence: 0.85`, `status: active`)
- [Rear Mount System](position/rear-mount-system.md) (`confidence: 0.80`, `status: active`)
- [Side Control System](position/side-control-system.md) (`confidence: 0.80`, `status: active`)
- [Turtle System](position/turtle-system.md) (`confidence: 0.80`, `status: active`)
...
- [Technical Lesson Delivery Model](procedures/technical-lesson-delivery-model.md) (`confidence: 0.90`, `status: active`)
- [Warm-Up Philosophy](procedures/warm-up-philosophy.md) (`confidence: 0.90`, `status: active`)

## Program Pages
- [Future Black Belt Program](programs/future-black-belt-program.md) (`confidence: 0.85`, `status: active`)
- [Kids Youth Development Program](programs/kids-youth-development-program.md) (`confidence: 0.90`, `status: active`)
