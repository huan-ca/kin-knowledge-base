...
## Opening Script
Introduce the theme: Double Leg to Side Control Fundamentals. Tell the class the goal is to connect the feet-to-floor entry with stable control on the ground.
