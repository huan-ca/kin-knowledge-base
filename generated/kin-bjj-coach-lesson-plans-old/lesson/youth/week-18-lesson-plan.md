...
## Opening Script
Introduce the theme: Arm Drag to Rear Body Lock Fundamentals. Tell the class the goal is to connect the feet-to-floor entry with stable control on the ground.
