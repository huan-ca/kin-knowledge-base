# Week 7 (Defensive Cycle)
- Theme: Arm Drag to Rear Body Lock Fundamentals
- Teaching Goal: Build a connected arm drag to rear angle or mat return into rear control entry and seatbelt management sequence.
- Class Length: 60 minutes

## Opening Script
- Theme setup: Arm Drag to Rear Body Lock Fundamentals.
- Main goal: Build a connected arm drag to rear angle or mat return into rear control entry and seatbelt management sequence.
...
## Lesson: Arm Drag to Rear Body Lock Fundamentals
- **Takedown**
  - Coaching Tip: Teach angle creation before grip chasing.
