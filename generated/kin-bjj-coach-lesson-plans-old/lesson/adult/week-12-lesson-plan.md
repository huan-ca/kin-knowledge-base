# Week 12 (Defensive Cycle)
- Theme: Double Leg to Side Control Fundamentals
- Teaching Goal: Build a connected double leg entry to a controlled finish on top into side control pin and basic top stabilization sequence.
- Class Length: 60 minutes

## Opening Script
- Theme setup: Double Leg to Side Control Fundamentals.
- Main goal: Build a connected double leg entry to a controlled finish on top into side control pin and basic top stabilization sequence.
...
## Lesson: Double Leg to Side Control Fundamentals
- **Takedown**
  - Coaching Tip: Connect the shot to top pressure without rushing the finish.
