# Adult Week 15 Fully Scripted Session
...
## Opening Script
Introduce the theme: Rear Mount Control To Strangle Finish. Tell the class the goal is Turn rear control into a high-percentage finishing system built on patient control and clean mechanics.
