# Adult Week 20 Fully Scripted Session
...
## Opening Script
Introduce the theme: Double Leg And Body-Lock Entries To Passing Finish. Tell the class the goal is Connect wrestling-style entries to immediate top control and passing follow-through.
