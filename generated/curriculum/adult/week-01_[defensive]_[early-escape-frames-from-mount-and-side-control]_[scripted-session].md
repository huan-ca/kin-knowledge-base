# Adult Week 01 Fully Scripted Session

## Opening Script
Introduce the theme: Early Escape Frames From Mount And Side Control. Tell the class the goal is Reinforce calm survival habits and first-stage escapes from the most common major pins.
