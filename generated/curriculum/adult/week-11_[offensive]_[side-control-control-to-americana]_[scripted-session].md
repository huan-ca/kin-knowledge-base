# Adult Week 11 Fully Scripted Session

## Opening Script
Introduce the theme: Side Control Control To Americana. Tell the class the goal is Use top control to build one reliable attack route instead of a loose collection of submissions.
